...
run('conan test Test/alpha/test_package alpha/1.0 --settings "&:build_type=Debug" --settings "alpha/1.0:build_type=Debug"')
#run('conan build Test/beta --settings "alpha/1.0:build_type=Debug"')
